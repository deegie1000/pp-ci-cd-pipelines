...
- Power Pages import strategy: read `powerPagesConfiguration` per solution; `deployMode` (UPGRADE/UPDATE/STAGE_FOR_UPGRADE) overrides the default `--stage-and-upgrade` logic
